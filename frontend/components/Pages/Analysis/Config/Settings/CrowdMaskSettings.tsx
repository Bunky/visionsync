    ...
    >
      <Group direction="column" grow>
        ...
        <Paper shadow="md" radius="md" p="md" sx={{ position: 'relative', overflow: 'hidden' }}>
          {!config.crowdMask.erosion.enabled && <Overlay opacity={dark ? 0.5 : 0.15} color="#000" zIndex={5} />}
          <Group position="left" direction="column" spacing="xs" sx={{ width: '100%' }}>
            <Group position="apart" direction="row" sx={{ width: '100%' }}>
        ...
        <Paper shadow="md" radius="md" p="md" sx={{ position: 'relative', overflow: 'hidden' }}>
          {!config.crowdMask.dilation.enabled && <Overlay opacity={dark ? 0.5 : 0.15} color="#000" zIndex={5} />}
          <Group position="left" direction="column" spacing="xs" sx={{ width: '100%' }}>
            <Group position="apart" direction="row" sx={{ width: '100%' }}>
        ...
        <Paper shadow="md" radius="md" p="md" sx={{ position: 'relative', overflow: 'hidden' }}>
          {!config.crowdMask.closing.enabled && <Overlay opacity={dark ? 0.5 : 0.15} color="#000" zIndex={5} />}
          <Group position="left" direction="column" spacing="xs" sx={{ width: '100%' }}>
            <Group position="apart" direction="row" sx={{ width: '100%' }}>
        ...
        <Paper shadow="md" radius="md" p="md" sx={{ position: 'relative', overflow: 'hidden' }}>
          {!config.crowdMask.opening.enabled && <Overlay opacity={dark ? 0.5 : 0.15} color="#000" zIndex={5} />}
          <Group position="left" direction="column" spacing="xs" sx={{ width: '100%' }}>
            <Group position="apart" direction="row" sx={{ width: '100%' }}>
